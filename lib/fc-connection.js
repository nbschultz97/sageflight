...
function createConnection() {
  ...
  return {
    async connect(path) {
      if (port && port.isOpen && comPort === path) return { comPort };
      await hardClose();
...
module.exports = { createConnection, parseAttitude, parseAnalog, parseRc, parseMotor, parseStatus, parseStatusEx, CMD };
