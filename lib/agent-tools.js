...
// deps: { detectFC, scanFC, withCli, runExclusive, store, forensic, connection, searchDocs }
function createToolExecutor(deps) {
  const { detectFC, scanFC, withCli, runExclusive, store, forensic, connection, searchDocs } = deps;
