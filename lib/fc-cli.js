...
const READ_COMMANDS = new Set([
  ...
  'sd_info', 'board_name', 'manufacturer_id', 'mcu_id',
  'rxrange', 'batch', 'gyroregisters', 'flash_info',
]);

// Read when bare (or with list/show), write when given arguments.
// vtxtable moved here from READ for the VTX tab: bare `vtxtable` dumps the
// table, `vtxtable band 1 ...` rewrites it.
const DUAL_COMMANDS = new Set([
  'aux', 'feature', 'serial', 'beeper', 'map', 'mixer', 'resource',
  'rateprofile', 'profile', 'vtx', 'vtxtable', 'rxfail', 'adjrange', 'servo', 'smix',
